...
from twoagentsagent import TwoAgentsAgent
...
class SimultaneousAgent(TwoAgentsAgent):
    ...
    def forward(self, observation):
        ...
        # ZMIANA # self.cur_agent = (self.cur_agent+1)%self.n
        # ZMIANA #
        #print("BABABABA:", observation)
        #print("BABABABA[0]:", observation[0])
        return self.agents[0].forward([observation[0]]), self.agents[1].forward([observation[1]])
    ...
    def backward(self, reward, terminal):
        ...
        """
        # test \/ \/ #
        # x = self.agents[0].backward(reward[0][0],terminal), self.agents[1].backward(reward[0][1],terminal)
        # print(x)
        #print(reward)
        #print(reward[0][0])
        #print(reward[0][1])
        return [self.agents[0].backward(reward[0],terminal), self.agents[1].backward(reward[1],terminal)] #[:len(self.agents[1].metrics_names)]
    ...
    def compile(self, optimizer, metrics=[]):
        ...
        '''
        self.m_names = [self.agents[0].metrics_names, self.agents[1].metrics_names]
        self.compiled = True
    ...
    def metrics_names(self):
        ...
        #print("@property metrics_names: self.m_names;\n", self.m_names)
