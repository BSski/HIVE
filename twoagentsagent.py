    ...
    def fit(self, env, nb_steps, action_repetition=1, callbacks=None, verbose=1,
        ...
        try:
            while self.step < nb_steps:
                ...
                # TU MUSISZ RODZIELIC NA DWA AGENTY #
                # ZMIANA #
                print(reward)
                ...
                episode_step += 1
                self.step += 1
                #print("################### twoagentsagent.py metrics:", metrics_one)
                if done:
    ...
    def test(self, env, nb_episodes=1, action_repetition=1, callbacks=None, visualize=True,
        ...
        for episode in range(nb_episodes):
            ...
            while not done:
                ...
                episode_reward[0] += reward[0]
                episode_reward[1] += reward[1]
                print("### test episode_reward", episode_reward)
            ...
            print("testowe episode:", episode, "BB", episode_logs)
            callbacks.on_episode_end(episode, episode_logs)
